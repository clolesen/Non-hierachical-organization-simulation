...
data120a6p = do.call(rbind, data_list)
...
#Asymetric projects
data_list = list()
#c(150,300,450), c(50, 300, 550) # 3 projects 18 agents 50 rounds
#c(100, 100, 150, 150, 200, 200), c(50, 100, 125, 175, 200, 250) # 6 projects 18 agents 50 rounds
#c(1000,2000,3000), c(350, 2000, 3650) # 3 projects 120 agents 50 rounds
#c(650, 650, 1000, 1000, 1350, 1350), c(350, 650, 850, 1150, 1350, 1650) # 6 projects 120 agents 50 rounds
cpList = list(c(650, 650, 1000, 1000, 1350, 1350), c(350, 650, 850, 1150, 1350, 1650)) #custom projects list
i = 1
for (cp in cpList){
  set.seed(61)
  for (s in 1:3){
...
asym_data120a6p = do.call(rbind, data_list)
...
ggplot(subset(data, Agent %in% c(1,9)), aes(x = Round, y = as.factor(Choice))) +
...
ggplot(data, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 2) +
  facet_wrap(~Simulation) +
  theme_minimal() +
...
ggplot(subset(asym_data, Agent %in% c(1,9)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
...
ggplot(asym_data, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 2) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")
...
# Reward plots
ggplot(data6p, aes(x = Round, y = Reward))+
  geom_line(aes(color = as.character(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Reward given each round", subtitle = "Agents seperated by color", color = "Agent")
...
# Reward - Expectation plots
ggplot(subset(data6p, Agent %in% c(1,9)), aes(x = Round)) +
  geom_point(aes(y = Project1_Rewards/Project1_Work), size = .4) +
  geom_line(aes(y = Expectation1, color = as.character(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
...
# total reward plot
ggplot(data6p, aes(y = Reward, x = Agent)) +
  stat_summary(fun.y = "sum", geom = "bar") + 
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Bar plot of the total sum of rewards per agent", subtitle = "Across 9 different simulations of 50 rounds each", y = "Sum of rewards")
...
#Project Choice plots
ggplot(subset(data6p, Agent %in% c(1,9)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 1 and 9 project choice", subtitle = "Across 9 different simulations of 50 rounds each", y = "Projects", color = "Agent")
...
ggplot(data6p, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 2) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")
...
###### 6 asymetric projects #########

ggplot(asym_data6p, aes(x = Round))+
  geom_line(aes(y = Project1_Tasks), color = 1) +
  geom_line(aes(y = Project2_Tasks), color = 2) +
  geom_line(aes(y = Project3_Tasks), color = 3) +
  geom_line(aes(y = Project4_Tasks), color = 4) +
...
# Reward plots
ggplot(asym_data6p, aes(x = Round, y = Reward))+
  geom_line(aes(color = as.character(Agent))) +
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
  labs(title = "Reward given each round", subtitle = "Agents seperated by color", color = "Agent")
...
# Reward - Expectation plots
ggplot(subset(asym_data6p, Agent %in% c(1,9)), aes(x = Round)) +
  geom_point(aes(y = Project1_Rewards/Project1_Work), size = .4) +
  geom_line(aes(y = Expectation1, color = as.character(Agent))) +
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
...
# total reward plot
ggplot(asym_data6p, aes(y = Reward, x = Agent)) +
  stat_summary(fun.y = "sum", geom = "bar") + 
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
  labs(title = "Bar plot of the total sum of rewards per agent", subtitle = "Across 6 different simulations of 50 rounds each", y = "Sum of rewards")
...
#Project Choice plots
ggplot(subset(asym_data6p, Agent %in% c(1,9)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Agent 1 and 9 project choice", subtitle = "Across 9 different simulations of 50 rounds each", y = "Projects", color = "Agent")
...
ggplot(asym_data6p, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 2) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")
...
#### 120 agent 3 projects ####
ggplot(data120a3p, aes(x = Round))+
  geom_line(aes(y = Project1_Tasks), color = 1) +
  geom_line(aes(y = Project2_Tasks), color = 2) +
  geom_line(aes(y = Project3_Tasks), color = 3) +
  facet_wrap(~Simulation) +
...
# Reward plots
ggplot(data120a3p, aes(x = Round, y = Reward))+
  geom_line(aes(color = as.character(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Reward given each round", subtitle = "Agents seperated by color", color = "Agent") +
...
# Reward - Expectation plots
ggplot(subset(data120a3p, Agent %in% c(10,90)), aes(x = Round)) +
  geom_point(aes(y = Project1_Rewards/Project1_Work), size = .4) +
  geom_line(aes(y = Expectation1, color = as.character(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 & 90, Reward and Expectation for project 1", subtitle = "The lines represents the expectation for agent 10 and 90, the dots represents the actual reward each round", y = "Reward - Expectation", color = "Agent")
...
ggplot(subset(data120a3p, Agent %in% c(10,90)), aes(x = Round)) +
  ...
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 & 90, Reward and Expectation for project 2", subtitle = "The lines represents the expectation for agent 10 and 90, the dots represents the actual reward each round", y = "Reward - Expectation", color = "Agent")
...
ggplot(subset(data120a3p, Agent %in% c(10,90)), aes(x = Round)) +
  ...
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 & 90, Reward and Expectation for project 3", subtitle = "The lines represents the expectation for agent 10 and 90, the dots represents the actual reward each round", y = "Reward - Expectation", color = "Agent")

# total reward plot
ggplot(data120a3p, aes(y = Reward, x = Agent)) +
  stat_summary(fun.y = "sum", geom = "bar") + 
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Bar plot of the total sum of rewards per agent", subtitle = "Across 9 different simulations of 50 rounds each", y = "Sum of rewards")
...
ggplot(subset(data120a3p, Agent %in% c(10,90)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 and 90 project choice", subtitle = "Across 9 different simulations of 50 rounds each", y = "Projects", color = "Agent")


ggplot(data120a3p, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 1) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")

#### 120 agenta 3 asymetric projects ####

# Project development over time
ggplot(asym_data120a3p, aes(x = Round))+
  geom_line(aes(y = Project1_Tasks), color = 1) +
  geom_line(aes(y = Project2_Tasks), color = 2) +
  geom_line(aes(y = Project3_Tasks), color = 3) +
  facet_wrap(cp~Simulation, ncol = 3) +
...
# Reward plots
ggplot(asym_data120a3p, aes(x = Round, y = Reward))+
  stat_summary(fun.y=min, geom="line") +
  stat_summary(fun.y=max, geom="line") +
  stat_summary(fun.y=mean, geom="line", color = "red") +
  facet_wrap(cp~Simulation, ncol = 3) +
...
# Reward - Expectation plots
ggplot(subset(asym_data120a3p, Agent %in% c(10,90)), aes(x = Round)) +
  geom_point(aes(y = Project1_Rewards/Project1_Work), size = .4) +
  geom_line(aes(y = Expectation1, color = as.character(Agent))) +
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
...
# total reward plot
ggplot(asym_data120a3p, aes(y = Reward, x = Agent)) +
  stat_summary(fun.y = "sum", geom = "bar") + 
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
  labs(title = "Bar plot of the total sum of rewards per agent", subtitle = "Across 6 different simulations of 50 rounds each", y = "Sum of rewards")
...
#Project Choice plots
ggplot(subset(asym_data120a3p, Agent %in% c(10,90)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 and 90 project choice", subtitle = "Across 9 different simulations of 50 rounds each", y = "Projects", color = "Agent")
...
ggplot(asym_data120a3p, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 1) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")
...
#### 120 agents 6 projects #####
ggplot(data120a6p, aes(x = Round))+
  geom_line(aes(y = Project1_Tasks), color = 1) +
  geom_line(aes(y = Project2_Tasks), color = 2) +
  geom_line(aes(y = Project3_Tasks), color = 3) +
  geom_line(aes(y = Project4_Tasks), color = 4) +
...
# Reward plots
ggplot(data120a6p, aes(x = Round, y = Reward))+
  stat_summary(fun.y=min, geom="line") +
  stat_summary(fun.y=max, geom="line") +
  stat_summary(fun.y=mean, geom="line", color = "red") +
  facet_wrap(~Simulation) +
...
# Reward - Expectation plots
ggplot(subset(data120a6p, Agent %in% c(10,90)), aes(x = Round)) +
  geom_point(aes(y = Project1_Rewards/Project1_Work), size = .4) +
  geom_line(aes(y = Expectation1, color = as.character(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
...
ggplot(subset(data120a6p, Agent %in% c(10,90)), aes(x = Round)) +
  ...
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 & 90, Reward and Expectation for project 4", subtitle = "The lines represents the expectation for agent 10 and 90, the dots represents the actual reward each round", y = "Reward - Expectation", color = "Agent")
...
ggplot(subset(data120a6p, Agent %in% c(10,90)), aes(x = Round)) +
  ...
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 & 90, Reward and Expectation for project 5", subtitle = "The lines represents the expectation for agent 10 and 90, the dots represents the actual reward each round", y = "Reward - Expectation", color = "Agent")
...
ggplot(subset(data120a6p, Agent %in% c(10,90)), aes(x = Round)) +
  ...
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 & 90, Reward and Expectation for project 6", subtitle = "The lines represents the expectation for agent 10 and 90, the dots represents the actual reward each round", y = "Reward - Expectation", color = "Agent")

# total reward plot
ggplot(data120a6p, aes(y = Reward, x = Agent)) +
  stat_summary(fun.y = "sum", geom = "bar") + 
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Bar plot of the total sum of rewards per agent", subtitle = "Across 9 different simulations of 50 rounds each", y = "Sum of rewards")
...
#Project Choice plots
ggplot(subset(data120a6p, Agent %in% c(10,90)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 and 90 project choice", subtitle = "Across 9 different simulations of 50 rounds each", y = "Projects", color = "Agent")
...
ggplot(data120a6p, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 1) +
  facet_wrap(~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")
...
###### 120 agents 6 asymetric projects #########

ggplot(asym_data120a6p, aes(x = Round))+
  geom_line(aes(y = Project1_Tasks), color = 1) +
  geom_line(aes(y = Project2_Tasks), color = 2) +
  geom_line(aes(y = Project3_Tasks), color = 3) +
  geom_line(aes(y = Project4_Tasks), color = 4) +
...
# Reward plot
ggplot(asym_data120a6p, aes(x = Round, y = Reward))+
  stat_summary(fun.y=min, geom="line") +
  stat_summary(fun.y=max, geom="line") +
  stat_summary(fun.y=mean, geom="line", color = "red") +
  facet_wrap(cp~Simulation, ncol = 3) +
...
# Reward - Expectation plots
ggplot(subset(asym_data120a6p, Agent %in% c(10,90)), aes(x = Round)) +
  geom_point(aes(y = Project1_Rewards/Project1_Work), size = .4) +
  geom_line(aes(y = Expectation1, color = as.character(Agent))) +
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
...
# total reward plot
ggplot(asym_data120a6p, aes(y = Reward, x = Agent)) +
  stat_summary(fun.y = "sum", geom = "bar") + 
  facet_wrap(cp~Simulation, ncol = 3) +
  theme_minimal() +
  labs(title = "Bar plot of the total sum of rewards per agent", subtitle = "Across 6 different simulations of 50 rounds each", y = "Sum of rewards")
...
#Project Choice plots
ggplot(subset(asym_data120a6p, Agent %in% c(10,90)), aes(x = Round, y = as.factor(Choice))) +
  geom_point(aes(color = as.factor(Agent))) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Agent 10 and 90 project choice", subtitle = "Across 9 different simulations of 50 rounds each", y = "Projects", color = "Agent")
...
ggplot(asym_data120a6p, aes(x = Round, y = as.factor(Agent))) +
  geom_point(aes(color = as.factor(Choice)), shape = 15, size = 1) +
  facet_wrap(cp~Simulation) +
  theme_minimal() +
  labs(title = "Project choice for all agents", subtitle = "Projects represented by color", y = "Actors", color = "Projects")
