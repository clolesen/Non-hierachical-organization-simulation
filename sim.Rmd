...
data6p = do.call(rbind, data_list)
...
#Asymetric projects
data_list = list()
cpList = list(c(100, 100, 150, 150, 200, 200), c(50, 100, 125, 175, 200, 250)) #custom projects list
i = 1
for (cp in cpList){
  set.seed(61)
  for (s in 1:3){
    d = simulation(nAgents, nProjects, nRounds, e, t, alpha, beta, s, cp)
    d$cp = paste(cp[1],cp[2],cp[3],cp[4],cp[5],cp[6])
    data_list[[i]] = d
    i = i + 1
  }
}

asym_data6p = do.call(rbind, data_list)
