...
simulation = function(nA, nP, nR, rewardExp, taskThresh, alpha, beta, sim){
  
  # Use other functions to set up the simulation
  network = createNetwork(nA)
  projects = createProjects(nA, nP, nR, pSymmetry)
...
ggplot(exp_data, aes(x = work, y = reward)) +
  ...
  xlim(0, 20) +
  ylim(0, 20) +
  labs(title = "Functions of how much total reward is given per project as the number of agents rise", subtitle = "The function is linear til 6 agents (18 (n agents) devided by 6 (n projects)) and exponential from there til 18. \nThe 6 plots show the function for different exponents", y = "Total reward", x = "Number of agents")
